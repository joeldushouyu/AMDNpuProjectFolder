...
int main(int argc, const char *argv[]) {
    ...
    //     .xclbin_name = "build/xclbins/aie.xclbin",
    //     .instr_name = "build/insts/aie.txt.redundant",
    // };
    ...
    vector<dtype_in> w_0 = npu_instance.create_bo_vector<dtype_in>(W_VOLUME, 3, app_id_0);
    vector<dtype_out> y_0 = npu_instance.create_bo_vector<dtype_out>(Y_VOLUME, 4, app_id_0);
