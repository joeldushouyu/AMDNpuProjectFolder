module {
  aie.device(npu2) {
    ...
    %in_buffer_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, sym_name = "in_buffer_0"} : memref<1176xf32> 
    ...
    %switch_diode_buffer = aie.buffer(%tile_0_2) {address = 5728 : i32, sym_name = "switch_diode_buffer"} : memref<1792xf32> 
    ...
    %A_B_C_D_buffer = aie.buffer(%tile_0_2) {address = 12896 : i32, sym_name = "A_B_C_D_buffer"} : memref<4144xf32> 
    ...
    func.func private @passThroughLine_float_1(memref<4144xf32>, memref<4144xf32>, i32)
    %out_buffer_0 = aie.buffer(%tile_0_2) {address = 29472 : i32, sym_name = "out_buffer_0"} : memref<8232xf32> 
    ...
    %A_B_C_D_debug_buffer = aie.buffer(%tile_1_2) {sym_name = "A_B_C_D_debug_buffer"} : memref<4144xf32> 
    ...
    ^bb3:  // pred: ^bb1
      ...
      aie.dma_bd(%A_B_C_D_buffer : memref<4144xf32>, 0, 1036)
      aie.use_lock(%A_B_C_D_con_lock, Release, 1)
      aie.next_bd ^bb1
    ^bb4:  // pred: ^bb2
      aie.use_lock(%A_B_C_D_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_B_C_D_buffer : memref<4144xf32>, 1036, 3108)
      aie.use_lock(%A_B_C_D_con_lock, Release, 1)
      aie.next_bd ^bb6
    ^bb5:  // pred: ^bb2
    ...
    ^bb6:  // 2 preds: ^bb4, ^bb7
      ...
      aie.dma_bd(%in_buffer_0 : memref<1176xf32>, 0, 588)
      aie.use_lock(%in_buffer_c_lock, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%in_buffer_p_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_buffer_0 : memref<1176xf32>, 588, 588)
      aie.use_lock(%in_buffer_c_lock, Release, 1)
      aie.next_bd ^bb6
    ^bb8:  // 2 preds: ^bb5, ^bb10
      aie.use_lock(%lock_0_2_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%out_buffer_0 : memref<8232xf32>, 0, 4116) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 9>}
    ...
    ^bb10:  // pred: ^bb8
      aie.use_lock(%lock_0_2_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%out_buffer_0 : memref<8232xf32>, 4116, 4116) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 9>}
      aie.use_lock(%lock_0_2, Release, 1)
      aie.next_bd ^bb8
    }
    ...
    ^bb3:  // pred: ^bb1
      ...
      aie.dma_bd(%A_B_C_D_debug_buffer : memref<4144xf32>, 0, 4144) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
      aie.use_lock(%lock_1_2, Release, 1)
      aie.next_bd ^bb1
    }
    func.func private @CT_main(memref<1176xf32>, memref<8232xf32>, i32, i32, i32, i32, i32, i32, i32, memref<1792xf32>)
    %core_0_2 = aie.core(%tile_0_2) {
      %c588_i32 = arith.constant 588 : i32
      %c4116_i32 = arith.constant 4116 : i32
      %c294_i32 = arith.constant 294 : i32
      %c8_i32 = arith.constant 8 : i32
      %c9_i32 = arith.constant 9 : i32
      %c10_i32 = arith.constant 10 : i32
      %c11_i32 = arith.constant 11 : i32
      func.call @CT_main(%in_buffer_0, %out_buffer_0, %c588_i32, %c4116_i32, %c294_i32, %c8_i32, %c9_i32, %c10_i32, %c11_i32, %switch_diode_buffer) : (memref<1176xf32>, memref<8232xf32>, i32, i32, i32, i32, i32, i32, i32, memref<1792xf32>) -> ()
      aie.end
    ...
    %core_1_2 = aie.core(%tile_1_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c4144_i32 = arith.constant 4144 : i32
        func.call @passThroughLine_float_1(%A_B_C_D_buffer, %A_B_C_D_debug_buffer, %c4144_i32) : (memref<4144xf32>, memref<4144xf32>, i32) -> ()
    ...
    memref.global "public" @in_SHM_CT_0_2_0 : memref<2828xf32>
    memref.global "public" @in_SHM_CT_0_2_1 : memref<5460xf32>
    memref.global "public" @B_CT_1_2_SHM : memref<5936xf32>
    memref.global "public" @out_CT_0_2_SHM : memref<16464xf32>
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<5936xf32>, %arg1: memref<5936xf32>, %arg2: memref<2352xf32>, %arg3: memref<16464xf32>) {
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 1, 1, 5936][0, 0, 0, 1]) {id = 0 : i64, issue_token = true, metadata = @B_CT_1_2_SHM} : memref<5936xf32>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 16, 7, 16][0, 112, 1, 7], packet = <pkt_type = 0, pkt_id = 6>) {id = 1 : i64, metadata = @in_SHM_CT_0_2_0} : memref<5936xf32>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 256][1, 4, 7, 37][0, 259, 1, 7], packet = <pkt_type = 0, pkt_id = 6>) {id = 2 : i64, metadata = @in_SHM_CT_0_2_0} : memref<5936xf32>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 404][1, 12, 7, 37][0, 259, 1, 7], packet = <pkt_type = 0, pkt_id = 8>) {id = 3 : i64, metadata = @in_SHM_CT_0_2_1} : memref<5936xf32>
      aiex.npu.dma_memcpy_nd(%arg3[0, 0, 0, 0][1, 1, 1, 16464][0, 0, 0, 1]) {id = 4 : i64, issue_token = true, metadata = @out_CT_0_2_SHM} : memref<16464xf32>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 1, 1, 2352][0, 0, 0, 1], packet = <pkt_type = 0, pkt_id = 8>) {id = 5 : i64, metadata = @in_SHM_CT_0_2_1} : memref<2352xf32>
