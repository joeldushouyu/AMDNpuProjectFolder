...
#define INPUT_SIZE 2
#define ITERATION_STEP_PER_PING_PONG_BUFFER 359
#define BUFFER_SIZE_OF_IN_PING_POING 718
#define BUFFER_SIZE_OF_OUT_PING_PONG 5026
#define PING_PONG_BUFFER_ITERATION 4
#define BUFFER_SIZE_OF_C1_DSW_MAT_RES 24
#define BUFFER_SIZE_OF_A_B_MAT_RES 24
#define BUFFER_SIZE_OF_X_U_CUR 28
#define BUFFER_SIZE_OF_INTERMEDIATE_C_D_MAT_RES 56
#define NUMBER_OF_SWITCH_DIODE_STATES 16
