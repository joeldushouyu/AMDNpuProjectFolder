...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile02_bd0), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile02_bd2), XAie_LockInit(4,-1),XAie_LockInit(5,1)));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile02_bd4), XAie_LockInit(1,-1),XAie_LockInit(0,1)));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile02_bd5), XAie_LockInit(1,-1),XAie_LockInit(0,1)));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile02_bd3), XAie_LockInit(4,-1),XAie_LockInit(5,1)));
...
// buffer _anonymous0 with unsupported type memref<1024xi16>;
// buffer _anonymous1 with unsupported type memref<1024xi16>;
// buffer _anonymous2 with unsupported type memref<1024xi16>;
// buffer _anonymous3 with unsupported type memref<1024xi16>;
const int _anonymous4_offset = 3072;
int32_t mlir_aie_read_buffer__anonymous4(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), _anonymous4_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer__anonymous4(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), _anonymous4_offset + (index*4), int_value);
return rc;
}
const int _anonymous5_offset = 18432;
int32_t mlir_aie_read_buffer__anonymous5(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), _anonymous5_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer__anonymous5(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), _anonymous5_offset + (index*4), int_value);
return rc;
}
