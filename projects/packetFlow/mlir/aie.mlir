...
module {
  aie.device(npu2) {
    ...
    aiex.runtime_sequence(%arg0: memref<64x64xi8>,%arg2: memref<64x64xi8>) {
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%tile_0_1) {
      ...
      %0 = aie.dma(S2MM, 0) [{
        ...
        //TODO:
        // no need packet heade when receive data from the input stream in this case, but possibly need it if still want to distinguish between the sender?
        // But if keep , need to increase the receive buffer size by 4 byte for space?
