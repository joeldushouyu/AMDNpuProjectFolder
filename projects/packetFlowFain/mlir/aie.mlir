...
module {
  aie.device(npu1_1col) {
    ...
    %objFifo_core02_buff_1 = aie.buffer(%tile_0_2) {sym_name = "objFifo_core02_buff_1"} : memref<64x64xi8> // Note, the pingpong is not used in the example, even though it got allocated
    ...
    // bring in on e128x64 matrix
    // top 64x64 matrix transfer to mt as one fifo
    // bottom 64x64(not offset in the npu.dma_memcpy_nd) transfer to mt as second fifo
    aiex.runtime_sequence(%arg0: memref<128x64xi8>,  %arg2: memref<128x64xi8>) {
