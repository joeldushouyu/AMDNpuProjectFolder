module {
  aie.device(npu1_1col) {
    ...
    %objFifo_core02_cons_buff_0 = aie.buffer(%tile_0_2) {sym_name = "objFifo_core02_cons_buff_0"} : memref<256xi8> 
    ...
    %objFifo_core03_cons_buff_0 = aie.buffer(%tile_0_3) {sym_name = "objFifo_core03_cons_buff_0"} : memref<256xi8> 
    %objFifo_core03_buff_0 = aie.buffer(%tile_0_3) {sym_name = "objFifo_core03_buff_0"} : memref<256xi8> 
    ...
    %objFifo_core03_prod_lock = aie.lock(%tile_0_3, 4) {init = 1 : i32, sym_name = "objFifo_core03_prod_lock"}
    %objFifo_core03_cons_lock = aie.lock(%tile_0_3, 5) {init = 0 : i32, sym_name = "objFifo_core03_cons_lock"}
    aie.packet_flow(0) {
    ...
    aiex.runtime_sequence(%arg0: memref<260xi8>, %arg1: memref<256xi8>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 1, 1, 260][0, 0, 0, 1]) {id = 0 : i64, metadata = @objFifo_in1} : memref<260xi8>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 1, 1, 256][0, 0, 0, 1]) {id = 2 : i64, issue_token = true, metadata = @objFifo_out1} : memref<256xi8>
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%mem_tile_0_1) {
      ...
      %objFifo_out0_buff_0 = aie.buffer(%mem_tile_0_1) {sym_name = "objFifo_out0_buff_0"} : memref<256xi8> 
